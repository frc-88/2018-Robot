 ...
 *
 */
public class ArmBasicControl extends Command {
    ...
    protected void execute() {
    	Robot.arm.basicMotion(TJUtility.polynomial(Robot.oi.operator.getLeftStickX(), POLY_A, POLY_B, POLY_C, DEADZONE));
    }
